...
class ProductManagementController {
  ...
  static Future<Response> getProducts(Request request) async {
    try {
      ...
      if (search != null && search.isNotEmpty) {
        products = await _productService.searchProducts(search, limit: limit, offset: offset);
      } else {
        products = await _productService.getProductsWithFilters(
          limit: limit,
          offset: offset,
  ...
  static Future<Response> getPartnerProducts(Request request) async {
    try {
      ...
      final products = await _productService.getProductsByPartner(id, limit: limit, offset: offset);
  ...
  static Future<Response> createProduct(Request request) async {
    try {
      ...
      final createdProduct = await _productService.createProduct(
        ...
        longDescription: data['longDescription'] as String? ?? data['description'] as String?,
      ...
      return Response.ok(
        jsonEncode(createdProduct.toJson()),
        headers: {'Content-Type': 'application/json'},
      );
    } catch (e) {
      return Response.internalServerError(
  ...
  static Future<Response> updateProduct(Request request) async {
    try {
      ...
      final existingProduct = await _productService.getProductById(id);
